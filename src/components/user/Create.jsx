...
import { validationUserData } from '../../userValidation'
        ...
        <div className="row flex-nowrap">
          ...
          <div className="col py-3">
            ...
            <form onSubmit={sendData}>
              ...
              <Input errors={errors} id={'useremail'} title={'user email'} value={user.email} type={'email'} name={'email'} HandelData={HandelData} />
              <Input errors={errors} id={'userpassword'} title={'user password'} value={user.password} cutomClass={'text-danger'} type={'password'} name={'password'} HandelData={HandelData} />
              <div className="mb-3">
                <button type="submit" className="form-control">Add user</button>
              </div>
            </form>
          </div>
        </div>
